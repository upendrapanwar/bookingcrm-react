                    ...
                    <main>
                        <div className="px-4 pt-6">
                            <div className="grid gap-4 xl:grid-cols-2 2xl:grid-cols-3">
                                {/* <button className="btn btn-success mb-3" onClick={getAllUser}>
                                    Get Users
                                </button> */}
                                <div className="p-4 bg-white border border-gray-200 rounded-lg shadow-sm 2xl:col-span-2 dark:border-gray-700 sm:p-6 dark:bg-gray-800">
                                    <div className="flex items-center justify-between mb-4">
                                        <div className="flex-shrink-0">
                                            <span className="text-xl font-bold leading-none text-gray-900 sm:text-2xl dark:text-white">{weeklySales.lastWeekAmount}</span>
                                        ...
                                        <div className={`flex items-center justify-end flex-1 text-base font-medium ${weeklySales.percentage >= 0 ? "text-green-500 dark:text-green-400" : "text-red-500 dark:text-red-400"}`}>
                                            {weeklySales.percentage}%
                                            {weeklySales.percentage >= 0 ? (
                                                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                                    <path fillRule="evenodd"
                                                        d="M5.293 7.707a1 1 0 010-1.414l4-4a1 1 0 011.414 0l4 4a1 1 0 01-1.414 1.414L11 5.414V17a1 1 0 11-2 0V5.414L6.707 7.707a1 1 0 01-1.414 0z"
                                                        clipRule="evenodd"></path>
                            ...
                            <div className="p-4 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 sm:p-6 dark:bg-gray-800 mt-4">
