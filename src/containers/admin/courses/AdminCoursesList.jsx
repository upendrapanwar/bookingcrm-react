...
const AdminCoursesList = () => {
    ...
    */
    const handleDetails = (id) => {
        navigate(`/admin/admin-courseDetails?id=${id}`);
    }
    /***********************************************************************/
    /***********************************************************************/
    /**
                            ...
                            cell: (row) => (
                                <>
                                    ...
                                    <button
                                        ...
                                        onClick={() => handleDetails(row.course_id)}
                                    >
                                        ...
                                        <span className="myactiveBtn">Details</span>
                                    </button>
                                    <button
                                        className=" mr-10 items-center px-3 w-15 text-sm font-medium text-center text-white bg-red-600 rounded-lg hover:bg-red-800 focus:ring-4 focus:ring-red-300 dark:focus:ring-red-900"
                        ...
                        <div className="p-4 bg-white block sm:flex items-center justify-between border-b border-gray-200 lg:mt-1.5 dark:bg-gray-800 dark:border-gray-700">
                            <div className="w-full mb-1">
                                <div className="mb-4">
                                    ...
                                    <h1 className="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">All courses</h1>
                                </div>
