                                    ...
                                    <nav className="flex mb-5" aria-label="Breadcrumb">
                                        <ol className="inline-flex items-center space-x-1 text-sm font-medium md:space-x-2">
                                            ...
                                            <li>
                                                <div className="flex items-center">
                                                    <svg className="w-6 h-6 text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clipRule="evenodd"></path></svg>
                                                    <span className="ml-1 text-gray-400 md:ml-2 dark:text-gray-500" aria-current="page">Create Course</span>
                                                </div>
                                            </li>
                                        </ol>
                                    </nav>
                                    <h1 className="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Create Course</h1>
                                </div>
                                                                                                                ...
                                                                                                                <tr key={index}>
                                                                                                                    ...
                                                                                                                    <td className="text-center align-middle">
                                                                                                                        <button
                                                                                                                            ...
                                                                                                                            className="btn btn-sm btn-outline-danger p-2"
                                                                                                                            onClick={() => {
                                                                                                                                const newLinks = zoomLinks.filter((_, i) => i !== index);
                                                                                                                                setZoomLinks(newLinks);
                                                                                                                                if (formikRef.current) {
                                                                                                                                    formikRef.current.setFieldValue("zoomLinks", newLinks);
                                                                                                                                }
