...
const Checkout = () => {
    ...
    useEffect(() => {
        //     // Calculate values when totalPrice changes
        ...
        console.log("futurePayAmount", futurePayAmount);
    ...
    // const FormObserverToPay = () => {
    //     const { values, setFieldValue } = useFormikContext(); // Access setFieldValue from Formik context
    //     console.log("valuesvaluesvaluesvaluesvalues", values)

    //     useEffect(() => {
    //         // Whenever toPayAmount or futurePayAmount changes, update Formik's state
    //         setFieldValue('toPayAmount', values.toPayAmount);
    //         setFieldValue('futurePayAmount', values.futurePayAmount);
    //     }, [values.toPayAmount, values.futurePayAmount, setFieldValue]); // Add dependencies
