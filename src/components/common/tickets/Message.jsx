...
const Message = ({ isOpen, toggleModal }) => {

  //const [replyVisible, setReplyVisible] = useState(false)
  useEffect(() => {
    if (!isOpen) {
      return null; // If modal is not open, return null (do not render modal)
    }
  ...
  return (
    <>
      {/*<Modal show={openModal} size="md" popup onClose={() => openModal(false)} >*/}
      <Modal show={isOpen} size="md" popup onClose={toggleModal} >
        <Modal.Header />
        <Modal.Body>
