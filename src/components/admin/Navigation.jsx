        ...
        <div className="px-3 py-3 lg:px-5 lg:pl-3">
            ...
            <div className="flex items-center">
                ...
                <div className="flex items-center ml-3">
                    ...
                    <div 
                    className={`absolute right-0 mt-0 bg-white divide-y divide-gray-100 rounded shadow-lg dark:bg-gray-700 dark:divide-gray-600 ${
                        isDropdownOpen ? "block" : "hidden"
                    }`}
                    id="dropdown-2"
                    style={{ top: '100%' }}
                    >
                      <div className="p-2 m-0 cursor-pointer" role="none" >
                            <p className=" m-0 text-sm text-gray-900 dark:text-white" role="none">
                        ...
                        <ul className="p-2 m-0 cursor-pointer" role="none">
                            {/* <li>
                            ...
                            <li className="block px-0 py-0 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem" onClick={logout}>Sign out
