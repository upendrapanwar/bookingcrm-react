...
import LogoImg from '../../assets/images/corpel-logo-white.png';
...
const Navigation = () => {
    ...
    return (
        <nav className="fixed z-30 w-full border-b border-gray-200 dark:border-gray-700 admin_header_nav">
            <div className="px-3 py-3 lg:px-5 lg:pl-3">
                <div className="flex items-center justify-between">
                    <div className="flex items-center justify-start">
                        <button id="toggleSidebarMobile" aria-expanded="true" aria-controls="sidebar" className="p-2 text-white">
                        ...
                        <Link to={"#"} className="flex ml-2 md:mr-24">
                            ...
                            {/* <span className="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">Booking Live Admin</span> */}
                        </Link>
                    ...
                    <div className="flex items-center">
                        <div className="hidden mr-3 -mb-1 sm:block">
                            <Link className="github-button" to={"#"} data-color-scheme="no-preference: dark; light: light; dark: light;" data-icon="octicon-star" data-size="large" data-show-count="true" aria-label="Star themesberg/flowbite-admin-dashboard on GitHub">Star</Link>
                        </div>
                    ...
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M8 4a4 4 0 100 8 4 4 0 000-8zM2 8a6 6 0 1110.89 3.476l4.817 4.817a1 1 0 01-1.414 1.414l-4.816-4.816A6 6 0 012 8z" clipRule="evenodd"></path></svg>
                        ...
                        <button type="button" data-dropdown-toggle="notification-dropdown" className="p-2 text-white rounded-lg hover:text-white dark:text-gray-400">
                        ...
                        <div className="z-20 z-50 hidden max-w-sm my-4 overflow-hidden text-base list-none bg-white divide-y divide-gray-100 rounded shadow-lg dark:divide-gray-600 dark:bg-gray-700" id="notification-dropdown">
                            ...
                            <div>
                                <Link to={"#"} className="flex px-4 py-3 border-b hover:bg-gray-100 dark:hover:bg-gray-600 dark:border-gray-600">
                        ...
                        <button type="button" data-dropdown-toggle="apps-dropdown" className="hidden p-2 text-white rounded-lg sm:flex ">
                            <span className="sr-only">View notifications</span>
                        ...
                        <div className="flex items-center ml-3">
                            <div className="relative">
                                <button type="button" className="flex text-sm bg-gray-800 rounded-full focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" id="user-menu-button-2" aria-expanded={isDropdownOpen} data-dropdown-toggle="dropdown-2"
                            ...
                            <div
                                className={`absolute right-0 mt-0 bg-white divide-y divide-gray-100 rounded shadow-lg dark:bg-gray-700 dark:divide-gray-600 ${isDropdownOpen ? "block" : "hidden"
                                    }`}
                                id="dropdown-2"
                                style={{ top: '100%' }}
                            >
                                <ul className="p-2 m-0" role="none">
                                    <li className="block px-2 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white">
                                        {authInfo ? authInfo.name : 'Guest'}
                                    </li>
                            ...
                            <li>
                                <Link to={"#"} className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem">Earnings</Link>
                                    ...
                                    <li className="block px-2 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white cursor-pointer" role="menuitem" onClick={logout}>Sign out
                                        {/* <Link to={"#"} className="block px-0 py-0 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem" onClick={logout}>Sign out</Link> */}
                                    </li>
                                </ul>
                            </div>
                        </div>
